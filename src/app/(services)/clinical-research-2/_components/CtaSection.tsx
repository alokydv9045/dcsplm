...
import { ArrowRight, GraduationCap, Phone, BookOpen } from 'lucide-react'
    ...
    return (
        <section className="section-padding bg-white">
            <div className="container-custom">
                ...
                >
                    {/* Background — matches Smart Manufacturing CTA */}
                    <div className="absolute inset-0 bg-[#0c0c1d]">
                        ...
                        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-secondary/20 rounded-full blur-[120px]" />
                    </div>

                    <div className="relative z-10 px-6 sm:px-10 md:px-16 py-14 sm:py-20 text-center">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white max-w-3xl mx-auto leading-tight">
                            {title}
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                            <Link
                                href={primaryLink?.href || "/contact-us"}
                            ...
                            >
                                {primaryLink?.label || "Enroll Now"} <ArrowRight className="w-5 h-5" />
                            </Link>
                            {secondaryLink ? (
                                <Link
